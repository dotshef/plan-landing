...
DB 테이블 정의는 [KIS_DB_SCHEMA.md](KIS_DB_SCHEMA.md), API·화면 매핑은 [KIS_API_CALL_LIST.md](../reference/KIS_API_CALL_LIST.md), 실측 스펙은 [KIS_API_SPEC_TEST.md](../reference/KIS_API_SPEC_TEST.md) 참고.
